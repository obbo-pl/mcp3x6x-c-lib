...
#define SPI_BUS_HAL_MISO                21       // CONFIG_SPI_BUS_HAL_MISO
#define SPI_BUS_HAL_MOSI                23       // CONFIG_SPI_BUS_HAL_MOSI
#define SPI_BUS_HAL_CLK                 19       // CONFIG_SPI_BUS_HAL_CLK
#define SPI_BUS_HAL_CS                  22       // CONFIG_SPI_BUS_HAL_CS
