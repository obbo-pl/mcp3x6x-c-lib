...
enum spi_mcp3x6x_status {
    SPI_MCP3X6X_STATUS_MASK_POR     = SPI_MCP3X6X_STATUS_POR_MASK,
    SPI_MCP3X6X_STATUS_MASK_CRCCFG  = SPI_MCP3X6X_STATUS_CRCCFG_MASK,
    SPI_MCP3X6X_STATUS_MASK_DR      = SPI_MCP3X6X_STATUS_DR_MASK
};
